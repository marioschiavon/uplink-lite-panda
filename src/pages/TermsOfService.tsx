      ...
      <div className="container mx-auto px-4 md:px-8 py-8 md:py-16 max-w-4xl">
        ...
        <div className="space-y-8 text-foreground">
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold text-foreground">1. OBJETO</h2>
          ...
          {/* Seção 2 */}
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold text-foreground">2. O QUE A UPLINK NÃO É E NÃO FAZ</h2>
          ...
          {/* Seção 3 */}
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold text-foreground">3. CADASTRO DO USUÁRIO</h2>
            <p className="leading-relaxed">
          ...
          {/* Seção 4 */}
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold text-foreground">4. PLANOS, COBRANÇA E REEMBOLSO</h2>
            <ul className="space-y-2 leading-relaxed list-disc list-inside ml-4">
          ...
          {/* Seção 5 */}
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold text-foreground">5. REGRAS DE USO</h2>
            <p className="leading-relaxed">
          ...
          {/* Seção 6 */}
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold text-foreground">6. LIMITAÇÕES DE RESPONSABILIDADE</h2>
            <p className="leading-relaxed">
          ...
          {/* Seção 7 */}
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold text-foreground">7. INTEGRAÇÕES EXTERNAS</h2>
            <p className="leading-relaxed">
          ...
          {/* Seção 8 */}
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold text-foreground">8. DADOS COLETADOS E PRIVACIDADE</h2>
            <p className="leading-relaxed">
          ...
          {/* Seção 9 */}
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold text-foreground">9. SUSPENSÃO OU ENCERRAMENTO DE CONTA</h2>
            <p className="leading-relaxed">
          ...
          {/* Seção 11 */}
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold text-foreground">11. LEGISLAÇÃO APLICÁVEL</h2>
            <p className="leading-relaxed">
